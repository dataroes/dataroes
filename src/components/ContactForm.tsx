...
function ContactForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    formData.set('g-recaptcha-response', recaptchaValue);
    ...
    <section id="contact" className="py-16 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-8 md:p-12">
          <h3 className="font-syne text-3xl font-bold text-slate-900 mb-2">
            Get in touch
          </h3>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                name="name"
                required
                className="mt-2 w-full rounded-xl border border-slate-200 px-4 py-3 text-sm text-slate-900 outline-none focus:ring-2 focus:ring-cobalt/20"
              />
            </div>
            ...
            <div className="md:col-span-2 flex flex-col gap-3">
              <div className="flex justify-center mb-2">
                <ReCAPTCHA
                  ref={recaptchaRef}
                  sitekey="6LePVv0sAAAAAGcFFt_6G-eCISMZZWyuaCxn9cVz"
              ...
              <button
                type="submit"
                disabled={submitting}
                className="rounded-xl bg-cobalt text-white px-6 py-3 font-semibold shadow hover:bg-cobalt-light transition disabled:cursor-not-allowed disabled:opacity-60"
              >
